...
BTN1.addEventListener('click', function() {
	let triger = 0;    //если переменная  triger=0, то обнуляем divForm (убираем форму)
	return function() {
		...
		if (triger == 1){
			...
			triger = 1;   //если переменная  riger=1, то обнуляем divForm и добавляем форму и кнопку
			divForm.innerHTML = '';
			divSel.innerHTML = '';
			divSearch.innerHTML = '';
...
BTN2.addEventListener('click', function() {
	let triger2 = 0;
	return function() {
		const elem2 = document.getElementById('btns2');
		if (triger2 == 1) {
			divSel.innerHTML = '';
			triger2 = 0;
		}else {
			...
			divSearch.innerHTML = '';
			elem2.innerHTML = '';
			elem2.appendChild(BTN2);
			elem2.appendChild(divSel);
...
BTN3.addEventListener('click', function() {
	let triger3 = 0;
	return function() {
		const elem3 = document.getElementById('btns3');
		if (triger3 == 1) {
			divSearch.innerHTML = '';
			triger3 = 0;
		}else {
			...
			divSearch.innerHTML = '';
			elem3.innerHTML = '';
			elem3.appendChild(BTN3);
			elem3.appendChild(divSearch);
